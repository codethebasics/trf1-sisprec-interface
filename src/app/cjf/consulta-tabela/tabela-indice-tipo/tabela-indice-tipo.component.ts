...
import { IndiceTipoWS } from '../../model/indice-tipo-ws';
...
export class TabelaIndiceTipoComponent {
  ...
  clickedRows = new Set<IndiceTipoWS>();
  selection = new SelectionModel<IndiceTipoWS>(true, []);

  // Armazena todas as requisições que foram alteradas em tela
  private requisicoesAlteradas: IndiceTipoWS[] = [];

  // Armazena o backup de todas as requisições alteradas
  private requisicoesBackup: IndiceTipoWS[] = [];

  constructor(private _liveAnnouncer: LiveAnnouncer) {
    this.headerColumns = Colunas.colunasIndiceTipo;
  }
