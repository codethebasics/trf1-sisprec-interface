...
import { MovimentoTipoWS } from '../../model/movimento-tipo-ws';
...
export class TabelaMovimentoTipoComponent {
  ...
  clickedRows = new Set<MovimentoTipoWS>();
  selection = new SelectionModel<MovimentoTipoWS>(true, []);

  // Armazena todas as requisições que foram alteradas em tela
  private requisicoesAlteradas: MovimentoTipoWS[] = [];

  // Armazena o backup de todas as requisições alteradas
  private requisicoesBackup: MovimentoTipoWS[] = [];
