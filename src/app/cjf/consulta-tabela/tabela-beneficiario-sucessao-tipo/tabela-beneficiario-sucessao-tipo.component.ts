...
import { BeneficiarioSucessaoTipoWS } from '../../model/beneficiario-sucessao-tipo-ws';
...
export class TabelaBeneficiarioSucessaoTipoComponent {
  ...
  clickedRows = new Set<BeneficiarioSucessaoTipoWS>();
  selection = new SelectionModel<BeneficiarioSucessaoTipoWS>(true, []);

  // Armazena todas as requisições que foram alteradas em tela
  private requisicoesAlteradas: BeneficiarioSucessaoTipoWS[] = [];

  // Armazena o backup de todas as requisições alteradas
  private requisicoesBackup: BeneficiarioSucessaoTipoWS[] = [];

  constructor(private _liveAnnouncer: LiveAnnouncer) {
    this.headerColumns = Colunas.colunasBeneficiarioSucessaoTipo;
  }
