...
import { UnidadeJudicialWS } from '../../model/unidade-judicial-ws';
...
export class TabelaUnidadeJudicialComponent {
  ...
  clickedRows = new Set<UnidadeJudicialWS>();
  selection = new SelectionModel<UnidadeJudicialWS>(true, []);

  // Armazena todas as requisições que foram alteradas em tela
  private requisicoesAlteradas: UnidadeJudicialWS[] = [];

  // Armazena o backup de todas as requisições alteradas
  private requisicoesBackup: UnidadeJudicialWS[] = [];

  constructor(private _liveAnnouncer: LiveAnnouncer) {
    this.headerColumns = Colunas.colunasUnidadeJudicial;
  }
