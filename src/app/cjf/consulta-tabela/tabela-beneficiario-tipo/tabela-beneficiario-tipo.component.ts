...
import { BeneficiarioTipoWS } from '../../model/beneficiario-tipo-ws';
...
export class TabelaBeneficiarioTipoComponent {
  ...
  clickedRows = new Set<BeneficiarioTipoWS>();
  selection = new SelectionModel<BeneficiarioTipoWS>(true, []);

  // Armazena todas as requisições que foram alteradas em tela
  private requisicoesAlteradas: BeneficiarioTipoWS[] = [];

  // Armazena o backup de todas as requisições alteradas
  private requisicoesBackup: BeneficiarioTipoWS[] = [];

  constructor(private _liveAnnouncer: LiveAnnouncer) {
    this.headerColumns = Colunas.colunasBeneficiarioTipo;
